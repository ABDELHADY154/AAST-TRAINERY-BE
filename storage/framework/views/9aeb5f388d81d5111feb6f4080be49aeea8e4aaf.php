    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card card-body">
                <form action="<?php echo e(route('trainingAdvisor.store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduation\AAST-TRAINERY-BE\AAST-TRAINERY-BE\resources\views/admin/advisor/create.blade.php ENDPATH**/ ?>