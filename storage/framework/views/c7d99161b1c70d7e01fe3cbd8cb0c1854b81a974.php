    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 d-flex">
                ...
                <a href="<?php echo e(route('companyInternshipPost.create')); ?>" class="btn btn-dark ml-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('companyInternshipPost.show',$post->id)); ?>" class="btn btn-primary">View</a>
                                
                                <form method="POST" action="<?php echo e(route('companyInternshipPost.destroy',$post->id)); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduation\AAST-TRAINERY-BE\AAST-TRAINERY-BE\resources\views/admin/compnayPost/index.blade.php ENDPATH**/ ?>