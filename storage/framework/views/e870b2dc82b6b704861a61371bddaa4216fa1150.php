    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 d-flex">
                ...
                <a href="<?php echo e(route('company.create')); ?>" class="btn btn-dark ml-3">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo e($company->phone_number); ?>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('company.show',$company->id)); ?>" class="btn btn-primary">View</a>
                                <a href="<?php echo e(route('company.edit',$company->id)); ?>" class="btn btn-success">Edit</a>
                                <form method="POST" action="<?php echo e(route('company.destroy',$company->id)); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduation\AAST-TRAINERY-BE\AAST-TRAINERY-BE\resources\views/admin/company/index.blade.php ENDPATH**/ ?>