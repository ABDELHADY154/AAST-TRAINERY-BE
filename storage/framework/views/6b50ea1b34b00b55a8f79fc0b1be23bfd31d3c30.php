    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 d-flex">
                ...
                <a href="<?php echo e(route('trainingAdvisor.create')); ?>" class="btn btn-dark ml-3">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Training Advisor</li>
            ...
            <div class="card card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($advisor->id); ?></td>
                            <td>
                                <?php echo e($advisor->advisor_name); ?>

                            </td>
                            <td>
                                <?php echo e($advisor->advisor_email); ?>

                            </td>

                            <td>
                                <?php echo e($advisor->department->department_name); ?>

                            </td>
                            <td class="text-center">
                                <a href="<?php echo e(route('trainingAdvisor.show',$advisor->id)); ?>" class="btn btn-primary">View</a>
                                <a href="<?php echo e(route('trainingAdvisor.edit',$advisor->id)); ?>" class="btn btn-success">Edit</a>
                                <form method="POST" action="<?php echo e(route('trainingAdvisor.destroy',$advisor->id)); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduation\AAST-TRAINERY-BE\AAST-TRAINERY-BE\resources\views/admin/advisor/index.blade.php ENDPATH**/ ?>