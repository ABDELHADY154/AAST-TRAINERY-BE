        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo e($company->company_name); ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="<?php echo e(asset('storage/images/companyLogo/' . $company->image),); ?>" alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center"><?php echo e($company->company_name); ?></h3>

                        <p class="text-muted text-center"><?php echo e($company->company_field); ?></p>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">About <?php echo e($company->company_name); ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                            <a href="mailto:<?php echo e($company->email); ?>" target="_blank"><?php echo e($company->email); ?></a>
                        </p>
                        ...
                        <p class="text-muted"><?php echo e($company->phone_number); ?></p>
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="post">
                                    ...
                                    <p>
                                        <?php echo e($company->company_desc); ?>
                            ...
                            <div class="tab-pane" id="timeline">
                                ...
                                <div class="timeline timeline-inverse">
                                    <!-- timeline time label -->
                                    <?php $__currentLoopData = $company->internshipPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduation\AAST-TRAINERY-BE\AAST-TRAINERY-BE\resources\views/admin/company/show.blade.php ENDPATH**/ ?>