    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 d-flex">
                <h1 class="m-0 text-dark">Session Review</h1>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Session Review</li>
        ...
        <div class="row">
            <div class="card card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach ($reviews as $stuReview)
                        <tr>
                            <td>{{$stuReview["review"]->id}}</td>
                            <td style="width: 20%">
                                {{$stuReview["student"]->name}}
                            </td>
                            <td>
                                {{$stuReview["post"]->title}}
                            </td>
                            <td class="text-center">
                                {{-- {{$stuReview["review"]->rate}} --}}
                                @if ($stuReview["review"]->rate == 1)
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                @elseif ($stuReview["review"]->rate == 2)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                @elseif ($stuReview["review"]->rate == 3)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                <i class="far fa-star"></i>
                                @elseif ($stuReview["review"]->rate == 4)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="far fa-star"></i>
                                @elseif ($stuReview["review"]->rate == 5)
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <td class="text-center">
                                <a href="{{route('sessionReview.show',$stuReview["review"]->id)}}" class="btn btn-primary">View</a>
                                <form method="POST" action="{{route('sessionReview.destroy',$stuReview["review"]->id)}}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
