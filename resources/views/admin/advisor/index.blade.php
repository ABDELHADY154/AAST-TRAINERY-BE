    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6 d-flex">
                ...
                <a href="{{route('trainingAdvisor.create')}}" class="btn btn-dark ml-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('trainingAdvisor.show',$advisor->id)}}" class="btn btn-primary">View</a>
                                <a href="{{route('trainingAdvisor.edit',$advisor->id)}}" class="btn btn-success">Edit</a>
                                <form method="POST" action="{{route('trainingAdvisor.destroy',$advisor->id)}}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
