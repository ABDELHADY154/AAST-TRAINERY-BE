        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('internshipReview.index')}}">Student Review</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="post">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <h3>Internship: </h3>
                        <h5 class="username">
                            @if ($post->post_type == "advisorPost")
                            <a href="{{route('trainingAdvisor.show',$post)}}">{{$post->internship_title}}</a>
                            @elseif ($post->post_type == "companyPost")
                            <a href="{{route('companyInternshipPost.show',$post)}}">{{$post->internship_title}}</a>
                            @elseif ($post->post_type == "promotedPost")
                            <a href="{{route('promotedPost.show',$post)}}">{{$post->internship_title}}</a>
                            @endif
                        </h5>
