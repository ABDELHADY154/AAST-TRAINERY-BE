...
Route::group([
    ...
    Route::group(['middleware' => ['studentAuth']], function () {
        ...
        Route::prefix('student')->group(function () {
            ...
            Route::post('/updatePassword', 'API\V1\StudentSubscribeController@updatePassword')->name('student.update.password');
            Route::post('/updateEmail', 'API\V1\StudentSubscribeController@updateEmail')->name('student.update.email');
